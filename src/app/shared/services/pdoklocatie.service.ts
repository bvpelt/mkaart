...
export class PdoklocatieService {
  private pdokLocUrl =
    'https://geodata.nationaalgeoregister.nl/locatieserver/v3'; // URL to web api
  private maxRows = 10;
  ...
  public getLookup(id: string): Observable<Lookup> {
    ...
    return this.http
      .get<Lookup>(url)
      .pipe(retry(3), catchError(this.handleError<Suggest>('getLookup', null)));
  }
